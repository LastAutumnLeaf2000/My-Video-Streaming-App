...
const Header = () => {
  ...
  useEffect(() => {
    if (searchQuerry) {
      //doesnt do setTimeout() if searchbox empty
      const timer = setTimeout(() => {
        if (getCache[searchQuerry]) {
          //checks whether getCache has searchQuerry or not
  ...
  return (
    <div className="sticky top-0 bg-black lg:bg-white">
      <div className="shadow-lg grid grid-flow-col">
        <div className="flex col-span-1 justify-evenly">
          <img
            ...
            alt="menu"
            className="w-0 lg:w-12 p-1 cursor-pointer"
        ...
        <div className="col-span-10 text-center my-auto">
          <form onSubmit={(e) => e.preventDefault()}>
            ...
            />
            <button
              className="px-2 border border-gray-400 bg-gray-100 rounded-r-full py-1
            "
          ...
          {showSuggestions && searchQuerry ? (
            <div className="absolute right-[6rem] lg:left-[29.6rem] mt-1 bg-white shadow-xl w-[11rem] lg:w-[37rem] text-start rounded-xl overflow-hidden border border-gray-100">
              <ul className="my-2">
